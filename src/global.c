...
MYBOOL _check_info = FALSE;				/* count files/folders before copy/delete */
...
char _sort_jak = 'N';					/* how to sort files [by Name] */
MYBOOL _sort_case = FALSE;				/* sort upper/lower case differently */
UWORD dirbuf_lines = DIRBUF_LIN;	/* reserved number of lines of 'DIRLINELEN' length */
